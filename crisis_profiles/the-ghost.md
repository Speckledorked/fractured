...
CRISIS PROFILE 04: THE GHOSTCore Instinct: WithdrawalCrisis Trigger: Interpersonal conflict, traumatic reminders, perceived rejection or failurePrimary Response: Emotional and/or physical isolationSecondary Response: Non-participation, disappearance, stealth-driven escapismBehavioral Signs:Stops speaking unless spoken toSleeps in different location or doesn’t sleepMisses meetings, fades from group dynamicsOnly surfaces in tactical/logistical momentsSpiral Path:Becomes unreachable—may walk off alone, fail to warn others, or break silently.Resilience Path:Can evolve into a vigilant shadow, offering protection from the fringes.Group Effect:Feels like emotional abandonmentOthers may lash out or overcompensateNPCs assume instability or mental breakdown✝️

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Ghost** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Ghost is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Ghost is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Ghost.
...
- On a **7–9**, they remain in the grip of The Ghost, but with a sliver of self-awareness or control.  
...
When The Ghost spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Ghost in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Ghost:
...
The Ghost affects not only the individual, but also the **group dynamic**:

- Once per session, when The Ghost clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
