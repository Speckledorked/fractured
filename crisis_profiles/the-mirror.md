...
CRISIS PROFILE 13: THE MIRRORCore Instinct: Emotional AbsorptionCrisis Trigger: Group collapse, interpersonal instability, survivor guiltPrimary Response: Reflects others’ emotions intensely—becomes what surrounds themSecondary Response: Internalizes group conflict, deteriorates rapidlyBehavioral Signs:Echoes group tone exactly—rage, silence, fearShifts rapidly based on others’ breakdownsDoesn’t share independent feelingsBecomes unstable around emotionally broken teammatesSpiral Path:Breaks when others do. Carries weight they shouldn’t. May copy harmful behaviors.Resilience Path:Becomes emotionally attuned leader—amplifies morale, protects hearts.Group Effect:Highly sensitive to group stateCan magnify chaos or unityRequires emotional balance from at least one other🧩

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Mirror** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Mirror is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Mirror is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Mirror.
...
- On a **7–9**, they remain in the grip of The Mirror, but with a sliver of self-awareness or control.  
...
When The Mirror spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Mirror in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Mirror:
...
The Mirror affects not only the individual, but also the **group dynamic**:

- Once per session, when The Mirror clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
