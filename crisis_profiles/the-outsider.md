...
CRISIS PROFILE 14: THE OUTSIDERCore Instinct: Distrust and DistanceCrisis Trigger: Isolation, betrayal, or being overlookedPrimary Response: Emotionally withdraws and assumes worst intentionsSecondary Response: Starts acting as if they are no longer part of the groupBehavioral Signs:Stops using “we” languageSleeps, eats, or guards alonePrepares solo escape plansAssumes every order or comment is a slightSpiral Path:May defect, betray, or abandon others. Could pre-emptively sabotage trust.Resilience Path:Can become fiercely loyal once truly accepted—but only once.Group Effect:Destabilizes social cohesionCan “infect” group with suspicionNPCs may echo distrust if it grows🔁

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Outsider** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Outsider is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Outsider is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Outsider.
...
- On a **7–9**, they remain in the grip of The Outsider, but with a sliver of self-awareness or control.  
...
When The Outsider spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Outsider in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Outsider:
...
The Outsider affects not only the individual, but also the **group dynamic**:

- Once per session, when The Outsider clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
