...
CRISIS PROFILE 09: THE COMMANDERCore Instinct: Authoritarian ControlCrisis Trigger: Chaos, weak leadership, moral ambiguityPrimary Response: Takes charge—hard. Demands obedience.Secondary Response: Overruling others, unilateral decisions, forced orderBehavioral Signs:Shifts into formal toneUses command language (“You will,” “Stand down”)Cuts off debateTakes high-risk or ethically gray actions for “the good of the group”Spiral Path:Becomes tyrant. Loses group support, enforces control through threat.Resilience Path:Forges hardened, respected leadership through earned results.Group Effect:Short-term clarity or chaos depending on player buy-inNPCs align quickly—unless already distrustfulMay save or doom the group based on decisions🔮

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The.
...
- On a **7–9**, they remain in the grip of The, but with a sliver of self-awareness or control.  
...
When The spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The:
...
The affects not only the individual, but also the **group dynamic**:

- Once per session, when The clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
