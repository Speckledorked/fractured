...
CRISIS PROFILE 02: THE MASKCore Instinct: Emotional ConcealmentCrisis Trigger: Internal fear, vulnerability, or pressure to lead without showing cracksPrimary Response: Silence, control of outward emotion, hidden collapseSecondary Response: Subtle withdrawal, suppressed grief or panicBehavioral Signs:Flat voice, blank expressions, polished answersAvoids personal questions or revealsTakes on more responsibility than neededDismisses empathy or soft talkSpiral Path:May suddenly implode or make catastrophic choices in isolation. Risk of disappearing or suicide.Resilience Path:Can become the quiet center others depend on—emotionally invisible, but unbreakable.Group Effect:Others may feel comfort—or alienatedEmotional friction builds without clear sourceNPCs may become suspicious or over-trusting🛠

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Mask** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Mask is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Mask is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Mask.
...
- On a **7–9**, they remain in the grip of The Mask, but with a sliver of self-awareness or control.  
...
When The Mask spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Mask in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Mask:
...
The Mask affects not only the individual, but also the **group dynamic**:

- Once per session, when The Mask clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
