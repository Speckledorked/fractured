...
CRISIS PROFILE 05: THE MARTYRCore Instinct: Self-SacrificeCrisis Trigger: Belief they’ve failed, survivor’s guilt, or need to redeem a lossPrimary Response: Voluntarily takes every risk, prioritizes others’ survivalSecondary Response: Willingly absorbs damage or consequences for othersBehavioral Signs:“Send me.” “I’ll hold them.”Gives up rations, gear, or medical careRefuses sleep or safety until others are secureDelivers final-sounding goodbyes frequentlySpiral Path:Dies unnecessarily, breaks group morale, leaves others guilty or angry.Resilience Path:Inspires others to carry hope and responsibility. Becomes spiritual leader or symbol.Group Effect:Emotionally potent—but often tragicOthers may start copying them or trying to stop themNPCs idolize or exploit the behavior⚓️

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Martyr** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Martyr is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Martyr is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Martyr.
...
- On a **7–9**, they remain in the grip of The Martyr, but with a sliver of self-awareness or control.  
...
When The Martyr spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Martyr in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Martyr:
...
The Martyr affects not only the individual, but also the **group dynamic**:

- Once per session, when The Martyr clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
