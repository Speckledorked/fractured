...
CRISIS PROFILE 07: THE FIREBRANDCore Instinct: ConfrontationCrisis Trigger: Injustice, leadership breakdown, moral ambiguityPrimary Response: Verbal or physical confrontationSecondary Response: Splinter factioning, calls for action or rebellionBehavioral Signs:Demands answers, decisions, or justiceUses sharp language or stirs others emotionallyPushes against leadership or cautionCan inspire or inflame depending on contextSpiral Path:Leads mutiny, fractures the team, causes reactive violence.Resilience Path:Catalyst for courageous decisions. Can drive moral clarity if channeled.Group Effect:Polarizing forceCan unite or divide rapidlyNPCs may fear or follow them🎭

---

## Mechanics (Crisis Profile Threshold System)

A **Crisis Profile** describes how this character destabilizes under sustained pressure. **The Firebrand** uses three thresholds: *Activation*, *Escalation*, and *Breaking*.

### Activation Threshold

When stress, stakes, or social context line up with this profile’s **Core Instinct** and **Crisis Triggers** as described above, the GM may declare that **The Firebrand is activating**.
...
If the situation continues or worsens — or if the character fails additional Trigger Rolls while The Firebrand is active — the Crisis Profile escalates.
...
At a critical moment — often tied to a **Red Line**, major loss, or pivotal decision — the GM can declare that the character has reached the **Breaking Threshold** for The Firebrand.
...
- On a **7–9**, they remain in the grip of The Firebrand, but with a sliver of self-awareness or control.  
...
When The Firebrand spirals at the Breaking Threshold:
...
- The GM frames at least one scene or beat where the group must respond to the damage caused by The Firebrand in full crisis mode.

---

### Resilience Path (Mechanical Effects)

When the character reaches the Breaking Threshold and rolls a 10+, or otherwise demonstrates a major breakthrough related to The Firebrand:
...
The Firebrand affects not only the individual, but also the **group dynamic**:

- Once per session, when The Firebrand clearly shapes the emotional tone of the group (for good or ill), the GM may either:  
